...
<head>
    ...
    <meta name="description" content="تسوّق مجموعة واسعة من الملابس، مستلزمات المنزل، أدوات المطبخ، منتجات الجمال، الأحذية، الألعاب وأكثر على موقع QBuy. نحن نقدم تجربة تسوق سهلة وممتعة مع تشكيلة متنوعة من المنتجات عالية الجودة. قم بزيارة موقعنا اليوم لتحقيق حلمك في العثور على أفضل العروض والصفقات الرائعة.">
    <title>Qbuym</title>
...
<body>
    ...
    <header dir="rtl">
        <!-- الشعار -->
        <a dir="ltr" href="index.php" class="logo"><i class='bx bx-pointer bx-rotate-90' ></i><b>Qbuym<sup id="country" class="country" style="position: relative; top: -0.5em; font-size: small; color: #00FF00;"></sup></b></a>
        <!-- أيقونة القائمة -->
        ...
        تسجيل الدخول -->
        <div class="sing">
            <p class="affiche">مرحبا، تسجيل الدخول <br><b>الحساب</b></p>
    ...
    <section class="productt" id="productt">
        ...
        <div class="products-container">
            <div class="box produ">
                ...
                <p>secription1</p>
                <div class="saledh">
                    <span class="throgh">24MAD</span>
                    <span class="sale">18MAD</span>
                </div> 
			...
			//	while($row = $result->fetch_assoc()) {
                ...
                //    echo '<div class="box produ">';
                 ...
                 //   if ($row['sale'] == 1) {
                   ...
                   //   echo '<span class="throgh">' . $row['price'] . ' MAD</span>';
                    //  echo '<span style="margin-left: 5px;" class="sale">' . $row['sale_price'] . ' MAD</span>';
                   //   echo '</div>';
                   // } else {
                   //   echo '<span class="sale" style="font-weight: 600;  padding-left: 25px; color: #0a0a0a; font-size: 1.2rem;" >' . $row['price'] . ' MAD</span>';
                  //  }
    ...
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
            ...
            if ($row['sale'] == 1) {
                ...
                echo '<span style="margin-left: 5px;" class="discount">' . $row['discount_percent'] . '% خصم</span>';
                echo '</div>';
            } else {
            ...
            if ($row['availability'] == 1) {
                echo '<span class="status">متاح</span>';
            } else if ($row['availability'] == 0) {
                echo '<span class="status" style="color: white; background-color: red;">غير متاح</span>';
            }
...
-->
        <div class="n">
            <div dir="rtl" class="woman">
                ...
                <span style="margin-right: 17px;"><a href="#∫"><p class="wom">شاهد اكثر</p></a></span>
            </div>
        <div class="products-container">
        <?php
            // Retrieve the products from the database
    ...
    echo '<span class="throgh" data-original-price="'.$row['price'].'">'
         .$row['price'].' MAD</span>';

    echo '<span class="sale" data-original-price="'.$row['sale_price'].'">'
         .$row['sale_price'].' MAD</span>';

} else {

    echo '<span class="sale" data-original-price="'.$row['price'].'">'
         .$row['price'].' MAD</span>';
}
...
-->
    ...
    <section class="about" id="about">
        ...
        <div dir="rtl" class="about-text">
            <h2>من نحن</h2>
            <p>Qbuym هي شركة بيع بالتجزئة عبر الإنترنت تهدف إلى توفير تجربة تسوق سريعة وسهلة للعملاء. مع التركيز على التسليم السريع ورضا العملاء، تلتزم Qbuym بتقديم منتجات عالية الجودة بأسعار معقولة.</p>

            <p>يتألف فريق Qbuym من محترفين ذوي خبرة وشغوفين بالتجارة الإلكترونية وتوفير أفضل خدمة ممكنة لعملائنا. سواء كنت تتسوق للضروريات أو تبحث عن مفاجأة خاصة، فإن Qbuym هنا لجعل حياتك أسهل وأكثر راحة.</p>

            <p>انضم إلى مجتمع Qbuym اليوم واستمتع بمستقبل التسوق!</p>

            <p>ملاحظة: يتم توضيح أصل الاختصار Qbuym بـ "Quick Buy Mohamed"، مما يشير إلى الشخص الذي يدير الشركة.</p>
        </div>
    </section>
    <!--customer
    ...
    <section dir="rtl" class="footer">
        <div class="footer-box">
            <a href="#" class="logo"><b> Qbuym</b><i class='bx bx-pointer bx-rotate-90' ></i></a>
            <p>نحب التواصل مع عملائنا في Qbuym، <br>
        ...
        <div class="footer-box">
            ...
            <li><a href="#index.php">تسوق الآن</a></li>
        </div>
        <div class="footer-box contact">
            <h3>تواصل</h3>
            <span><i class='bx bxs-map'></i>&nbsp;&nbsp;مدينة الرباط، المغرب</span>
            <span><i class='bx bx-phone'></i>&nbsp;&nbsp;<span dir="ltr">+212 695-654094</span></span>
            <span><i class='bx bx-envelope'></i>&nbsp;&nbsp;info@qbuym.com</span>
        </div>
    </section>
    <!--<section class="home" id="home">
    ...
    <div class="copyright">
        <p>&copy; 2026 <b>Qbuym</b> <span  dir="rtl"> جميع الحقوق محفوظة . </span></p>
    </div>
    ...
    <script>
        ...
        /*
        // to display country in sup in Qbuym (logo).
        window.addEventListener('load', getInfo);
        async function getInfo() {
         const response = await fetch("https://ipinfo.io/json?token=f1eb2f6f76ec86");
         const data = await response.json();
         
         const country = data.country;
         
         const supElement = document.getElementById('country');
         supElement.innerHTML = country;
        }
        */
    ...
    productPrices.forEach((priceElement, index) => {
        let originalPriceInMAD = parseFloat(priceElement.dataset.originalPrice);

        if (isNaN(originalPriceInMAD) || originalPriceInMAD <= 0) {
            originalPriceInMAD = parseFloat(priceElement.dataset.price);
        }

        if (isNaN(originalPriceInMAD) || originalPriceInMAD <= 0) {
            originalPriceInMAD = parseFloat(priceElement.textContent);
        }

        if (isNaN(originalPriceInMAD) || originalPriceInMAD <= 0) {
            priceElement.textContent = 'Prix indisponible';
            return;
        }

        let convertedPrice = originalPriceInMAD * conversionRates[currencyCode];
        ...
        if (originalPriceElement) {
            let originalPrice = parseFloat(originalPriceElement.dataset.originalPrice);

            if (isNaN(originalPrice) || originalPrice <= 0) {
                originalPrice = parseFloat(originalPriceElement.textContent);
            }

            if (!isNaN(originalPrice) && originalPrice > 0) {
                let convertedOriginalPrice = originalPrice * conversionRates[currencyCode];
